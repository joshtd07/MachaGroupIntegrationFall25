...
function FireSafetyTrainingPage() {
    ...
    const uploadImage = httpsCallable(functions, 'uploadFireSafetyTrainingImage');
    ...
    useEffect(() => {
        ...
        const fetchFormData = async () => {
            ...
            const formDocRef = doc(db, 'forms', 'Continuous Improvement - Safety and Security', 'Fire Safety Training', buildingId);
    ...
    const questions = [
        { name: "fireSafetyTopics", label: "What specific topics are covered in the fire safety training program for staff?", type: "text" },
        { name: "fireSafetyFrequency", label: "How often is fire safety training conducted for employees?", type: "text" },
        { name: "fireSafetyEvaluation", label: "What methods are used to evaluate staff understanding and retention of fire safety protocols?", type: "text" },
        { name: "fireDrillsFrequency", label: "Are fire drills incorporated into the training program, and if so, how frequently are they held?", type: "text" },
        { name: "fireSafetyFeedback", label: "How is the training adjusted based on feedback from participants or after incidents?", type: "text" }
    ];
        ...
        <div> {/* Outer wrapper div */}
            <div className="form-page">
                <header className="header">
                    ...
                    <h1>7.2.3.1.1 Fire Safety Training Assessment</h1>
                ...
                <main className="form-container">
                    <form onSubmit={handleSubmit}>
                         ...
                         <h2>7.2.3.1.1 Fire Safety Training Details:</h2>
                        ...
                        <div className="form-section">
                            <label>Upload Image (Optional):</label>
                             ...
                             {imageUrl && <img src={imageUrl} alt="Uploaded Safety Training Context" style={{ maxWidth: '200px', marginTop: '10px' }}/>}
