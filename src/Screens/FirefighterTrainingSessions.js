...
function FirefighterTrainingSessionsPage() {
    ...
    const uploadImage = httpsCallable(functions, 'uploadFirefighterTrainingSessionsImage');
    ...
    useEffect(() => {
        ...
        const fetchFormData = async () => {
            ...
            const formDocRef = doc(db, 'forms', 'Community Partnership', 'Firefighter Training Sessions', buildingId);
    ...
    const questions = [
        { name: "collaborationTrainingSessions", label: "What types of training sessions are conducted for firefighters in collaboration with schools?", type: "text" },
        { name: "trainingSessionsAddressingNeeds", label: "How are these training sessions tailored to address the specific needs of the school environment?", type: "text" },
        { name: "trainersQualifications", label: "What qualifications and experience do trainers have to ensure effective firefighter training sessions?", type: "text" },
        { name: "oftenTrainingSessionsAndEffectiveness", label: "How often are firefighter training sessions held, and what is the process for evaluating their effectiveness?", type: "text" },
        { name: "feedbackMechanisms", label: "What feedback mechanisms are in place for school staff and students to share their experiences from these training sessions?", type: "text" }
    ];
        ...
        <div> {/* Outer wrapper div */}
            <div className="form-page">
                <header className="header">
                    ...
                    <h1>Firefighter Training Sessions Assessment</h1>
                ...
                <main className="form-container">
                    <form onSubmit={handleSubmit}>
                        {/* Section title using numbering from original code */}
                         <h2>6.1.2.2.3 Firefighter Training Sessions Details:</h2>
                        ...
                        <div className="form-section">
                            <label>Upload Image (Optional):</label>
                             ...
                             {imageUrl && <img src={imageUrl} alt="Uploaded Training Session Context" style={{ maxWidth: '200px', marginTop: '10px' }}/>}
