...
function PersonalSafetyEducationPage() {
  ...
  const handleButtonClick = (section) => {
    ...
    switch (section) {
        case 'Stranger Danger Awareness':
            navigate('/StrangerDangerAwareness2');
            break;
        default:
    ...
    <div className="form-page">
      ...
      <main className="form-container">
        ...
        <form>
          ...
          {['Stranger Danger Awareness'].map((section, index) => (
...
export default PersonalSafetyEducationPage;