...
import { getFirestore, doc, getDoc, setDoc, }  from 'firebase/firestore'; // Removed collection, kept serverTimestamp
...
function FirstAidCPRTraining2FormPage() {
    ...
    const totalQuestions = firstAidCprTrainingQuestions.length;
        ...
        if (buildingId) {
            try {
                ...
                // handleChange calculates progress and saves alongside form data
                    const total = firstAidCprTrainingQuestions.length;
