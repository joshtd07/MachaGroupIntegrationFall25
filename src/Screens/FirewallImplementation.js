...
function FirewallImplementationPage() {
    ...
    const uploadImage = httpsCallable(functions, 'uploadFirewallImplementationImage');
    ...
    useEffect(() => {
        ...
        const fetchFormData = async () => {
            ...
            const formDocRef = doc(db, 'forms', 'Continuous Improvement - Safety and Security', 'Firewall Implementation and Configuration', buildingId);
    ...
    const questions = [
        { name: "firewallSelectionCriteria", label: "What criteria are used to select and implement firewall solutions within the network?", type: "text" },
        { name: "firewallReviewFrequency", label: "How frequently is the firewall configuration reviewed and updated to address emerging threats?", type: "text" },
        { name: "firewallACLs", label: "What specific access control lists (ACLs) have been established to restrict unauthorized access through the firewall?", type: "text" },
        { name: "firewallLogMonitoring", label: "How are firewall logs monitored for suspicious activity or potential breaches?", type: "text" },
        { name: "firewallTraining", label: "What training or resources are provided to staff responsible for managing and maintaining the firewall?", type: "text" }
    ];
        ...
        <div> {/* Outer wrapper div */}
            <div className="form-page">
                <header className="header">
                    ...
                    <h1>7.3.2.1.1 Firewall Implementation Assessment</h1>
                ...
                <main className="form-container">
                    <form onSubmit={handleSubmit}>
                         ...
                         <h2>7.3.2.1.1 Firewall Implementation Details:</h2>
                        ...
                        <div className="form-section">
                            <label>Upload Image (Optional):</label>
                             ...
                             {imageUrl && <img src={imageUrl} alt="Uploaded Firewall Context" style={{ maxWidth: '200px', marginTop: '10px' }}/>}
