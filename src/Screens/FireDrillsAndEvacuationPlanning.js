...
function FireDrillsAndEvacuationPlanningPage() {
    ...
    const uploadImage = httpsCallable(functions, 'uploadFireDrillsAndEvacuationPlanningImage');
    ...
    useEffect(() => {
        ...
        const fetchFormData = async () => {
            ...
            const formDocRef = doc(db, 'forms', 'Community Partnership', 'Fire Drills and Evacuation Planning', buildingId);
    ...
    const questions = [
        { name: "frequentFireDrills", label: "How frequently are fire drills conducted within the school to ensure preparedness?", type: "text" },
        { name: "communicatingEvacuationPlans", label: "What procedures are in place for communicating evacuation plans to students and staff before a drill?", type: "text" },
        { name: "assignedRoles", label: "How are roles and responsibilities assigned during fire drills, and who oversees the execution?", type: "text" },
        { name: "accommodatingDisabilityStudents", label: "What strategies are implemented to accommodate students with disabilities during evacuation procedures?", type: "text" },
        { name: "postDrillFeedback", label: "How is feedback collected post-drill to identify areas for improvement in the evacuation plan?", type: "text" }
    ];
        ...
        <div> {/* Outer wrapper div */}
            <div className="form-page">
                <header className="header">
                    ...
                    <h1>Fire Drills and Evacuation Planning Assessment</h1>
                ...
                <main className="form-container">
                    <form onSubmit={handleSubmit}>
                        {/* Section title using numbering from original code */}
                         <h2>6.1.2.1.2 Fire Drills and Evacuation Planning Details:</h2>
                        ...
                        <div className="form-section">
                            <label>Upload Image (Optional):</label>
                             ...
                             {imageUrl && <img src={imageUrl} alt="Uploaded Evacuation Planning Context" style={{ maxWidth: '200px', marginTop: '10px' }}/>}
