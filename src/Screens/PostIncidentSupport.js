...
import { getFirestore, doc, getDoc, setDoc,} from 'firebase/firestore'; // Keep serverTimestamp if needed inside formData
...
function PostIncidentSupportFormPage() {
    ...
    const totalQuestions = postIncidentSupportQuestions.length;
            ...
            try {
                ...
                const dataToSave = {
                 ...
                 // handleChange calculates progress and saves alongside form data
                    const total = postIncidentSupportQuestions.length;
