...
function FireDrills2Page() {
    ...
    const uploadImage = httpsCallable(functions, 'uploadFireDrills2Image');
    ...
    useEffect(() => {
        ...
        const fetchFormData = async () => {
            ...
            const formDocRef = doc(db, 'forms', 'Continuous Improvement - Safety and Security', 'Fire Drills 2', buildingId);
    ...
    const questions = [
        { name: "fireDrillFrequency", label: "How often are fire drills conducted throughout the school year?", type: "text" },
        { name: "evacuationProcedures", label: "What procedures are in place to ensure that all students and staff can evacuate the building quickly and safely during a fire drill?", type: "text" },
        { name: "fireDrillTracking", label: "How is student participation in fire drills tracked and assessed for compliance?", type: "text" },
        { name: "disabilityAccommodations", label: "Are there accommodations for students with disabilities during fire drills, and how are those addressed?", type: "text" },
        { name: "fireDrillFeedback", label: "How is feedback collected after fire drills to improve future drill procedures?", type: "text" }
    ];
        ...
        <div> {/* Outer wrapper div */}
            <div className="form-page">
                <header className="header">
                    ...
                    <h1>7.2.4.2.1 Fire Drills Assessment</h1>
                ...
                <main className="form-container">
                    <form onSubmit={handleSubmit}>
                         ...
                         <h2>7.2.4.2.1 Fire Drills Details:</h2>
                        ...
                        <div className="form-section">
                            <label>Upload Image (Optional):</label>
                             ...
                             {imageUrl && <img src={imageUrl} alt="Uploaded Fire Drills 2 Context" style={{ maxWidth: '200px', marginTop: '10px' }}/>}
