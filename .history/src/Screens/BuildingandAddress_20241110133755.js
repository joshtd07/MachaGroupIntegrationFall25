...
function BuildingInfoPage() {
    ...
    const handleNavigateToForms = () => {
        navigate('/form'); // Navigate to the forms page without submitting
    };
    ...
    return (
        <div className="form-page">
            ...
            <main className="form-container">
                ...
                {/* Navigate to the forms page without submitting */}
                <button type="button" onClick={handleNavigateToForms} style={{ marginTop: '20px' }}>
                    Go to Forms Page
                </button>
            </main>
        </div>
