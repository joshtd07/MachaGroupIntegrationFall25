  ...
  <main className="form-container">
    <form>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="materials-availability" value="yes" /> Yes
          <input type="radio" name="materials-availability" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="materials-storage" placeholder="Describe the materials stored" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="storage-accessibility" value="yes" /> Yes
          <input type="radio" name="storage-accessibility" value="no" /> No
        </div>
        <div>
          <input type="text" name="storage-area-description" placeholder="Describe the area" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="backup-materials" value="yes" /> Yes
          <input type="radio" name="backup-materials" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="materials-communication" placeholder="Describe how participants are informed" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="inspection-frequency" placeholder="How often" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="issue-resolution" value="yes" /> Yes
          <input type="radio" name="issue-resolution" value="no" /> No
        </div>
        <div>
          <input type="text" name="issue-resolution-details" placeholder="Describe the protocols" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="staff-training-maintenance" placeholder="Describe the method" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="materials-stocking" value="yes" /> Yes
          <input type="radio" name="materials-stocking" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="inventory-management" placeholder="Describe how materials are managed" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="stock-monitoring" value="yes" /> Yes
          <input type="radio" name="stock-monitoring" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="replenishment-thresholds" value="yes" /> Yes
          <input type="radio" name="replenishment-thresholds" value="no" /> No
        </div>
        <div>
          <input type="text" name="replenishment-details" placeholder="Describe the criteria" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="supplier-selection" placeholder="Describe how suppliers are selected" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="materials-quality" value="yes" /> Yes
          <input type="radio" name="materials-quality" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="selection-guidelines" value="yes" /> Yes
          <input type="radio" name="selection-guidelines" value="no" /> No
        </div>
        <div>
          <input type="text" name="guidelines-details" placeholder="Describe the guidelines" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="participant-feedback" value="yes" /> Yes
          <input type="radio" name="participant-feedback" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="materials-evaluation" placeholder="Describe how it's evaluated" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="quality-monitoring" value="yes" /> Yes
          <input type="radio" name="quality-monitoring" value="no" /> No
        </div>
        <div>
          <input type="text" name="monitoring-details" placeholder="Describe the mechanisms" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="usage-training" value="yes" /> Yes
          <input type="radio" name="usage-training" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="materials-integration" placeholder="Describe how it's integrated" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="usability-feedback" value="yes" /> Yes
          <input type="radio" name="usability-feedback" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="storage-guidelines" value="yes" /> Yes
          <input type="radio" name="storage-guidelines" value="no" /> No
        </div>
        <div>
          <input type="text" name="storage-protocols" placeholder="Describe the guidelines" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="materials-customization" placeholder="Describe how it's adapted/customized" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="materials-records" value="yes" /> Yes
          <input type="radio" name="materials-records" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="inventory-documentation" placeholder="Describe how it's documented and updated" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="materials-tracking" value="yes" /> Yes
          <input type="radio" name="materials-tracking" value="no" /> No
        </div>
        <div>
          <input type="text" name="tracking-procedures" placeholder="Describe the procedures" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="inventory-discrepancies" placeholder="Describe how discrepancies are identified" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="incident-documentation" value="yes" /> Yes
          <input type="radio" name="incident-documentation" value="no" /> No
        </div>
        <div>
          <input type="text" name="incident-protocols" placeholder="Describe the protocols" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="security-measures" value="yes" /> Yes
          <input type="radio" name="security-measures" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="security-procedures" placeholder="Describe how training materials are secured" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="access-controls" value="yes" /> Yes
          <input type="radio" name="access-controls" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="sensitive-materials-protection" placeholder="Describe how training materials are secured" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="staff-security-training" value="yes" /> Yes
          <input type="radio" name="staff-security-training" value="no" /> No
        </div>
      </div>
