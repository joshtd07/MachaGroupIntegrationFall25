            ...
            <main className="form-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-section">
                        ...
                        <textarea name="heuristicDetection" onChange={handleChange}></textarea>
                    </div>
                    ...
                    <div className="form-section">
                        ...
                        <textarea name="scanScheduling" onChange={handleChange}></textarea>
                    </div>
                    ...
                    <div className="form-section">
                        ...
                        <textarea name="customizableAlerts" onChange={handleChange}></textarea>
                    </div>
                    ...
                    <div className="form-section">
                        ...
                        <textarea name="threatIntelligenceSharing" onChange={handleChange}></textarea>
                    </div>
