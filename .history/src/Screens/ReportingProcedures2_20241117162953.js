...
function ReportingProcedures2Page() {
  ...
  const handleButtonClick = (section) => {
    ...
    if (section === 'Incident Reporting') {
      navigate('/incident-reporting'); // Replace with the actual path for Incident Reporting
    } else if (section === 'Contact Information') {
      navigate('/contact-information'); // Replace with the actual path for Contact Information
    }
  };
