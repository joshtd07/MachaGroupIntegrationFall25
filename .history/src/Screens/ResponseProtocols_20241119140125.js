  ...
  <main className="form-container">
    <form>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="protocol-development-standards" value="yes" /> Yes
          <input type="radio" name="protocol-development-standards" value="no" /> No
        </div>
        <div>
          <input type="text" name="protocol-development-description" placeholder="Describe how protocols are developed" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="protocol-tailoring" value="yes" /> Yes
          <input type="radio" name="protocol-tailoring" value="no" /> No
        </div>
        <div>
          <input type="text" name="specific-emergency-types" placeholder="Describe the specific types" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="protocol-considerations" placeholder="Describe the considerations" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="protocol-review" value="yes" /> Yes
          <input type="radio" name="protocol-review" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="immediate-actions" placeholder="Describe the actions" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="initial-response-training" value="yes" /> Yes
          <input type="radio" name="initial-response-training" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="protocol-communication" placeholder="Describe how protocols are communicated" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="designated-initiators" value="yes" /> Yes
          <input type="radio" name="designated-initiators" value="no" /> No
        </div>
        <div>
          <input type="text" name="initiator-teams" placeholder="List the designated individuals/teams" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="external-coordination" placeholder="Describe how protocols are coordinated" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="communication-procedures" placeholder="Describe the communication procedures" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="notification-channels" value="yes" /> Yes
          <input type="radio" name="notification-channels" value="no" /> No
        </div>
        <div>
          <input type="text" name="notification-channels-details" placeholder="Describe the channels/protocols" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="communication-systems" placeholder="Describe how these ensure rapid and reliability" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="backup-communication" value="yes" /> Yes
          <input type="radio" name="backup-communication" value="no" /> No
        </div>
        <div>
          <input type="text" name="backup-methods" placeholder="Describe the backup methods/redundancy" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="communication-training" placeholder="Describe how they're trained" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="decision-authority" placeholder="Describe the decision-making authority" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="decision-framework-training" value="yes" /> Yes
          <input type="radio" name="decision-framework-training" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="empowerment-mechanisms" placeholder="Describe the decision-making authority" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="delegation-protocols" value="yes" /> Yes
          <input type="radio" name="delegation-protocols" value="no" /> No
        </div>
        <div>
          <input type="text" name="delegation-details" placeholder="Describe the protocols" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="decision-documentation" placeholder="Describe how decisions are documented" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="training-methods" placeholder="Describe how staff members are trained" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="scenario-drills" value="yes" /> Yes
          <input type="radio" name="scenario-drills" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="drill-frequency" placeholder="Describe how often" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="debriefing-sessions" value="yes" /> Yes
          <input type="radio" name="debriefing-sessions" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="retention-measures" placeholder="Describe the measures" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="protocol-documentation" placeholder="Describe how protocols are documented" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="protocol-review-evaluation" value="yes" /> Yes
          <input type="radio" name="protocol-review-evaluation" value="no" /> No
        </div>
        <div>
          <input type="text" name="review-details" placeholder="Describe the protocols" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="performance-metrics" placeholder="Describe the metrics/indicators" />
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="radio" name="post-incident-analyses" value="yes" /> Yes
          <input type="radio" name="post-incident-analyses" value="no" /> No
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div>
          <input type="text" name="lessons-learned-sharing" placeholder="Describe how lessons are learned" />
        </div>
      </div>
    </form>
  </main>
